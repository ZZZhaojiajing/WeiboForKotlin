...
class MainActivity : BaseActivity() {
    ...
    var fragmentMe: BaseFragment? = null
...
//
    ...
    private fun setSelectTab() {
        ...
        //点击我
        ll_tab.findViewById<LinearLayout>(R.id.ll_tab_me)
                .setOnClickListener(object : View.OnClickListener {
                    override fun onClick(p0: View?) {
                        checkMe()
                        listview.smoothScrollToPosition(0)
        ...
        ll_sus_tab.findViewById<LinearLayout>(R.id.ll_tab_me)
                .setOnClickListener(object : View.OnClickListener {
                    override fun onClick(p0: View?) {
                        checkMe()
                    }
    ...
    private fun checkHomePage() {
        ...
        ll_tab.findViewById<TextView>(R.id.tv_me).setTextColor(Color.BLACK)
        ...
        ll_tab.findViewById<View>(R.id.view_me).visibility = View.INVISIBLE
        //悬浮导航栏选中效果
        ...
        ll_sus_tab.findViewById<TextView>(R.id.tv_me).setTextColor(Color.BLACK)
        ...
        ll_sus_tab.findViewById<View>(R.id.view_me).visibility = View.INVISIBLE
    }
     ...
     */
    private fun checkMe() {
        switchContent(mCurrentFragment!!, fragmentMe!!)

        ll_tab.findViewById<TextView>(R.id.tv_me).setTextColor(Color.parseColor("#e3ba97"))
        ll_tab.findViewById<TextView>(R.id.tv_homepage).setTextColor(Color.BLACK)
        ll_tab.findViewById<TextView>(R.id.tv_weibo).setTextColor(Color.BLACK)
        ll_tab.findViewById<View>(R.id.view_me).visibility = View.VISIBLE
        ll_tab.findViewById<View>(R.id.view_homepage).visibility = View.INVISIBLE
        ll_tab.findViewById<View>(R.id.view_weibo).visibility = View.INVISIBLE
        //悬浮导航栏选中效果
        ll_sus_tab.findViewById<TextView>(R.id.tv_me).setTextColor(Color.parseColor("#e3ba97"))
        ll_sus_tab.findViewById<TextView>(R.id.tv_homepage).setTextColor(Color.BLACK)
        ll_sus_tab.findViewById<TextView>(R.id.tv_weibo).setTextColor(Color.BLACK)
        ll_sus_tab.findViewById<View>(R.id.view_me).visibility = View.VISIBLE
        ll_sus_tab.findViewById<View>(R.id.view_homepage).visibility = View.INVISIBLE
        ll_sus_tab.findViewById<View>(R.id.view_weibo).visibility = View.INVISIBLE
    }
